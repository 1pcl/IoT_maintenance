...
def run_single_simulation():
    ...
    selected_modules_by_zone = {
        "zone1": ["heartbeat", "rts_cts", "wireless_power", "remote_restart"],
        "zone2": ["heartbeat", "remote_restart"],
        "zone3": ["heartbeat", "rts_cts", "short_restart"],
        "zone4": ["heartbeat"]
    }
    ...
    simulation_params_by_zone = {
        "zone1": {
            ...
            "frequency_heartbeat_max":60
        },
        "zone2": {
            "preventive_check_days": 3,
            "frequency_heartbeat": 300,  
            "heartbeat_loss_threshold": 3,
            "frequency_heartbeat_min":5,
            "frequency_heartbeat_max":300
        },
        "zone3": {
            "preventive_check_days": 2,
            "frequency_heartbeat": 900,  
            "heartbeat_loss_threshold": 3,
            "frequency_heartbeat_min":15,
            "frequency_heartbeat_max":900
        },
        "zone4": {
            "preventive_check_days": 7,
            "frequency_heartbeat": 1800,  
            "heartbeat_loss_threshold": 3,
            "frequency_heartbeat_min":30,
            "frequency_heartbeat_max":1800
        }
    }
            ...
            zone_parameters.extend([
                {
                    ...
                    'min': params["frequency_heartbeat_min"], 
                    'max': params["frequency_heartbeat_max"],  
                    'weight': 0.1, 
