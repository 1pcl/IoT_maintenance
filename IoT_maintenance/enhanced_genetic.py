...
def plot_ga_convergence(convergence_data, elapsed_time, num_procs):
    ...
    with open("results1/ga_convergence_data.json", "w") as f:
    ...
    plt.tight_layout()
    plt.savefig('results1/ga_convergence.png', dpi=300)
    print("Saved: results1/ga_convergence.png")
    plt.close()
    ...
    plt.legend(fontsize=14)
    plt.tight_layout()
    plt.savefig('results1/ga_feasible_count.png', dpi=300)
    print("Saved: results1/ga_feasible_count.png")
    plt.close()
    ...
    plt.legend(fontsize=14)
    plt.tight_layout()
    plt.savefig('results1/ga_diversity.png', dpi=300)
    print("Saved: results1/ga_diversity.png")
    plt.close()
    ...
    plt.legend(fontsize=14)
    plt.tight_layout()
    plt.savefig('results1/ga_mutation_rate.png', dpi=300)
    print("Saved: results1/ga_mutation_rate.png")
    plt.close()

def replot_from_saved_data():
    """从保存的数据重新绘制图表"""
    try:
        with open("results1/ga_convergence_data.json", "r") as f:
...
if __name__ == "__main__":
    ...
    try:
        ...
        # 写入结果文件
        with open("results1/ga_optimization_results.txt", "w") as f:
